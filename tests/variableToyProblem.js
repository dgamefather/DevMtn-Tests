module.exports = {
    ...
    'Test data': browser => {
        var newEmployeeName = 'dgamefather';
        var newEmployeePhone = '3853519040';
        var newEmployeeTitle = 'Twitch Affiliate';
        browser
        ...
        browser
            .expect.element('input[name="phoneEntry"]').value.to.equal(newEmployeePhone);
        browser
            .expect.element('input[name="titleEntry"]').value.to.equal(newEmployeeTitle);
    }
}