...
module.exports = {
    ...
    'SpamBot - Mars': browser => {
        slack
            .click('@mars')
            .waitForElementPresent('@text')
            // .setValue('@text', ['5 minute SPAM WARNING! TURN ON DO NOT DISTURB ASAP!!!!! Have a nice day. ;)', browser.Keys.ENTER])
            // .pause(300000);
            .setValue('@text', ['2 minute SPAM WARNING! Only sending 2-4 msgs to test new concepts.', browser.Keys.ENTER])
            .pause(120000);
        for (var x = 0; x <= 2; x++) {
            slack
